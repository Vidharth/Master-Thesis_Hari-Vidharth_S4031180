...
\begin{center}
    ...
    \vspace{1cm}{\bf{\large Accelerating Reinforcement Learning with\\
    \vspace{0.1mm}Behavior Cloning for Multi-Goal Robotic\\
    \vspace{1mm}Interaction and Manipulation Tasks}}\\
