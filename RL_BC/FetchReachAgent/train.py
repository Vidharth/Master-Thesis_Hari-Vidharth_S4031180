...
class Agent():
	def __init__(self, env):
		...
		self.agent_memory = Memory(1000000, (13, ), env.action_space.shape[0])
		self.demo_memory = Memory(2500, (13, ), env.action_space.shape[0])
	...
	def demo_learn(self):
		...
		if self.learn_step_counter % 2 == 0:
			...
			wandb.log({"Critic 1 Loss": critic_1_loss})
			wandb.log({"Critic 2 Loss": critic_2_loss})
...
if __name__ == "__main__":
	...
	wandb.init(project="FetchReach-v1", entity="Vidharth")
